<template>
  <nav class=" max-w-3xl mx-auto py-2 w-11/12 flex justify-between">
    <router-link to="/"><i class='bx bxs-chevron-left bx-sm'></i></router-link>
    <button type="button" @click="fetchData"><i class='bx bx-refresh bx-sm'></i></button>
  </nav>
